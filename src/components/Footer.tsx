      ...
      <Container>
        <div className="flex flex-col items-center py-10 sm:flex-row-reverse sm:justify-between">
          {/* Both links are deliberately left at "#" until real profile URLs
              ...
              `prefetch={false}` because "#" resolves to the current route, and
              next/link would otherwise fetch the page it is already on. */}
          <div className="flex gap-x-6">
            <Link
              href="#"
              prefetch={false}
              className="group"
              aria-label="BooliiTheme on X"
            >
              <svg
            ...
            <Link
              ...
              prefetch={false}
              className="group"
              aria-label="BooliiTheme on GitHub"
            >
              <svg
                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
                aria-hidden="true"
