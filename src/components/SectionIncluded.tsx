...
const features = [
  ...
  },
  {
    name: '100% responsive',
    description:
      'Ncmaz is designed to be responsive on all devices, from mobile to desktop. Ncmaz is built with the latest Tailwind CSS 4, which is a mobile-first CSS framework.',
  },
  {
    name: 'RTL support',
    description:
      'Ncmaz supports right-to-left languages out of the box, so you can easily localize your site for a global audience.',
  },
  {
    name: 'Easy to customize',
    description:
      'Ncmaz is designed to be easy to customize to your liking, with a well-organized file structure and clean code.',
  },
]
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <div className="col-span-2">
            ...
            <p className="mt-6 text-base/7 text-gray-600">
              Ncmaz comes with everything you need to get started building a
              beautiful, modern blog, news and magazine websites. Here are just
              a few of the features you’ll find in the template that make it a
